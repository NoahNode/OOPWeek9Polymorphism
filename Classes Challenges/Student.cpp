...
Student::Student(std::string name) {
	SetName(name);
	std::cout << "The first custom Student class constructor was called to create " << GetName() << std::endl;
	numberofStudents_++;
}
...
Student::Student(std::string name, std::string registration, std::string course, int yearofStudy) : registrstionID_{ registration }, course_{ course},
	yearofStudy_{ yearofStudy}
{
	SetName(name);
	std::cout << "The second custom Student class constructor was called to create " << GetName() << std::endl;
	numberofStudents_++;
...
void Student::ToString() const {
	std::string output = GetName() + " " + registrstionID_ + " " + course_ + " " + std::to_string(yearofStudy_) + " " + "\n";
...
std::string Student::ToString() {
	std::string PersonString = Person::ToString() + ", " + registrstionID_ + ", " + course_ + ", " + std::to_string(yearofStudy_);
	return PersonString;
}
